...
def sample_tree_0():
    ...
    PRE0 = Leaf("PRE0_st0", 0.7, alg=pre0)
    PRE1 = Leaf("PRE1_st0", 0.3, alg=pre1)
    X = Leaf("X_st0", .9, alg=x)
    Y = Leaf("Y_st0", .8, alg=y)
...
@lru_cache(1)
def sample_tree_1():
    PRE0 = Leaf("PRE0_st1", 0.7, alg=None)
    PRE1 = Leaf("PRE1_st1", 0.6, alg=None)
    X = Leaf("X_st1", 0.5, alg=None)
    Y = Leaf("Y_st1", 0.4, alg=None)
...
def sample_tree_2():
    ...
    PRE0 = Leaf("PRE0_st2", 0.7, alg=pre0)
    PRE1 = Leaf("PRE1_st2", 0.3, alg=pre1)
    PRE2 = Leaf("PRE2_st2", 0.3, alg=pre2)
    pre12 = CompositeNode(
...
def sample_tree_3():
    ...
    C0 = Leaf("C0_st3", 0.7, alg=c0)
    C1 = Leaf("C1_st3", 0.8, alg=c1)
    C2 = Leaf("C2_st3", 1, alg=c2)
    C3 = Leaf("C3_st3", 0.5, alg=c3)
