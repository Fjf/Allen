...
def HLT1Sequence(
    ...
    velo_pv_ip = velo_pv_ip_t(
        ...
        dev_velo_kalman_beamline_states_t = velo_kalman_filter.dev_velo_kalman_beamline_states_t(),
    ...
    kalman_velo_only = kalman_velo_only_t(
        ...
        dev_scifi_track_ut_indices_t = scifi_consolidate_tracks.dev_scifi_track_ut_indices_t(),
    ...
    hlt1_sequence = Sequence(
        ...
        prefix_sum_secondary_vertices, fit_secondary_vertices, odin_banks, run_hlt1, prepare_raw_banks,
