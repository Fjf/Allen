...
def MuonSequence(
    ...
    is_muon = is_muon_t(
        ...
        dev_scifi_track_ut_indices_t = scifi_consolidate_tracks_t.dev_scifi_track_ut_indices_t(),
        dev_station_ocurrences_offset_t = muon_station_ocurrence_prefix_sum.dev_output_buffer_t(),
        dev_muon_hits_t = muon_populate_hits.dev_muon_hits_t())

    return Sequence(
        muon_banks, muon_calculate_srq_size, muon_srq_prefix_sum,
        muon_populate_tile_and_tdc, muon_add_coords_crossing_maps,
        muon_station_ocurrence_prefix_sum, muon_populate_hits, is_muon)
