...
def CaloSequence(initialize_lists):
    ...
    prefix_sum_ecal_num_digits = host_prefix_sum_t(
        ...
        dev_input_buffer_t=calo_decode.dev_ecal_num_digits_t())

    prefix_sum_hcal_num_digits = host_prefix_sum_t(
        name="prefix_sum_hcal_num_digits",
        dev_input_buffer_t=calo_decode.dev_hcal_num_digits_t())
    ...
    calo_seed_clusters = calo_seed_clusters_t(
        ...
        dev_ecal_num_digits_t=calo_decode.dev_ecal_num_digits_t(),
        dev_hcal_num_digits_t=calo_decode.dev_hcal_num_digits_t(),
