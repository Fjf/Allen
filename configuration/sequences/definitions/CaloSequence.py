...
def CaloSequence(initialize_lists):
    ...
    calo_decode = calo_decode_t(
        name="calo_decode",
        host_number_of_events_t=initialize_lists.host_number_of_events_t(),
        host_ecal_number_of_digits_t=prefix_sum_ecal_num_digits.host_total_sum_holder_t(),
        host_hcal_number_of_digits_t=prefix_sum_hcal_num_digits.host_total_sum_holder_t(),
        dev_event_list_t=initialize_lists.dev_event_list_t(),
        ...
        dev_ecal_digits_offsets_t=prefix_sum_ecal_num_digits.dev_output_buffer_t(),
        dev_hcal_digits_offsets_t=prefix_sum_hcal_num_digits.dev_output_buffer_t())
    ...
    calo_sequence = Sequence(
        ecal_banks, hcal_banks, calo_count_digits,
        prefix_sum_ecal_num_digits, prefix_sum_hcal_num_digits,
        calo_decode, calo_seed_clusters,
