...
def VeloSequence(initialize_lists):
    ...
    velo_copy_track_hit_number = velo_copy_track_hit_number_t(
        ...
        dev_output_buffer_t(),
        dev_offsets_number_of_three_hit_tracks_filtered_t=prefix_sum_offsets_number_of_three_hit_tracks_filtered.
        dev_output_buffer_t())
    ...
    velo_consolidate_tracks = velo_consolidate_tracks_t(
        ...
        host_number_of_three_hit_tracks_filtered_t=prefix_sum_offsets_number_of_three_hit_tracks_filtered.
        host_total_sum_holder_t(),
        host_number_of_events_t=initialize_lists.host_number_of_events_t(),
