...
struct dev_odin_raw_input_t : run_hlt1::Parameters::dev_odin_raw_input_t,
                              populate_odin_banks::Parameters::dev_odin_raw_input_t,
...
struct dev_event_list_t : prepare_decisions::Parameters::dev_event_list_t,
...
struct dev_velo_states_t : lf_quality_filter::Parameters::dev_velo_states_t,
...
struct dev_multi_fit_vertices_t : velo_pv_ip::Parameters::dev_multi_fit_vertices_t,
...
struct dev_number_of_multi_fit_vertices_t : VertexFit::Parameters::dev_number_of_multi_fit_vertices_t,
...
struct dev_ut_windows_layers_t : ut_search_windows::Parameters::dev_ut_windows_layers_t,
...
struct dev_offsets_ut_track_hit_number_t : lf_calculate_parametrization::Parameters::dev_offsets_ut_track_hit_number_t,
...
struct dev_ut_track_hits_t : ut_consolidate_tracks::Parameters::dev_ut_track_hits_t,
                             prepare_decisions::Parameters::dev_ut_track_hits_t,
                             prepare_raw_banks::Parameters::dev_ut_track_hits_t {
  constexpr static auto name {"dev_ut_track_hits_t"};
  size_t size;
  char* offset;
};
struct dev_ut_qop_t : prepare_raw_banks::Parameters::dev_ut_qop_t,
...
struct dev_scifi_raw_input_offsets_t : scifi_raw_bank_decoder_v4::Parameters::dev_scifi_raw_input_offsets_t,
...
struct dev_scifi_hit_offsets_t : scifi_direct_decoder_v4::Parameters::dev_scifi_hit_offsets_t,
...
struct dev_scifi_hits_t : scifi_raw_bank_decoder_v4::Parameters::dev_scifi_hits_t,
...
struct dev_scifi_lf_found_triplets_t : lf_triplet_keep_best::Parameters::dev_scifi_lf_found_triplets_t,
...
struct dev_scifi_lf_tracks_t : lf_quality_filter_length::Parameters::dev_scifi_lf_tracks_t,
...
struct dev_scifi_lf_atomics_t : lf_quality_filter_length::Parameters::dev_scifi_lf_atomics_t,
...
struct dev_scifi_lf_parametrization_t : lf_extend_tracks_x::Parameters::dev_scifi_lf_parametrization_t,
                                        ...
                                        lf_calculate_parametrization::Parameters::dev_scifi_lf_parametrization_t {
...
struct dev_offsets_forward_tracks_t : run_postscale::Parameters::dev_offsets_forward_tracks_t,
...
struct dev_offsets_scifi_track_hit_number : FilterTracks::Parameters::dev_offsets_scifi_track_hit_number,
...
struct dev_scifi_qop_t : kalman_velo_only::Parameters::dev_scifi_qop_t,
...
struct dev_scifi_states_t : kalman_velo_only::Parameters::dev_scifi_states_t,
...
struct dev_scifi_track_ut_indices_t : kalman_pv_ipchi2::Parameters::dev_scifi_track_ut_indices_t,
...
struct dev_muon_raw_to_hits_t : muon_sort_by_station::Parameters::dev_muon_raw_to_hits_t,
                                muon_add_coords_crossing_maps::Parameters::dev_muon_raw_to_hits_t,
                                muon_pre_decoding::Parameters::dev_muon_raw_to_hits_t {
...
struct dev_atomics_muon_t : muon_add_coords_crossing_maps::Parameters::dev_atomics_muon_t,
                            muon_sort_by_station::Parameters::dev_atomics_muon_t,
                            muon_pre_decoding::Parameters::dev_atomics_muon_t,
...
struct dev_muon_hits_t : muon_sort_by_station::Parameters::dev_muon_hits_t,
                         is_muon::Parameters::dev_muon_hits_t,
                         muon_add_coords_crossing_maps::Parameters::dev_muon_hits_t {
  constexpr static auto name {"dev_muon_hits_t"};
  size_t size;
  char* offset;
};
struct dev_muon_compact_hit_t : muon_add_coords_crossing_maps::Parameters::dev_muon_compact_hit_t,
                                muon_sort_by_station::Parameters::dev_muon_compact_hit_t {
  constexpr static auto name {"dev_muon_compact_hit_t"};
  size_t size;
  char* offset;
};
struct dev_station_ocurrences_sizes_t : host_prefix_sum::Parameters::dev_input_buffer_t,
...
struct dev_is_muon_t : kalman_pv_ipchi2::Parameters::dev_is_muon_t, is_muon::Parameters::dev_is_muon_t {
...
struct host_number_of_svs_t : prepare_decisions::Parameters::host_number_of_svs_t,
                              host_prefix_sum::Parameters::host_total_sum_holder_t,
...
struct dev_sv_offsets_t : VertexFit::Parameters::dev_sv_offsets_t,
...
struct dev_sel_results_t : run_postscale::Parameters::dev_sel_results_t,
                           prepare_decisions::Parameters::dev_sel_results_t,
...
struct dev_candidate_counts_t : prepare_raw_banks::Parameters::dev_candidate_counts_t,
                                prepare_decisions::Parameters::dev_candidate_counts_t {
...
struct dev_saved_svs_list_t : prepare_raw_banks::Parameters::dev_saved_svs_list_t,
                              prepare_decisions::Parameters::dev_saved_svs_list_t {
