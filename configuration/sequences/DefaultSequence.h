...
ARG(dev_h0_candidates_t,
  velo_fill_candidates::dev_h0_candidates_t,
  velo_search_by_triplet::dev_h0_candidates_t)
ARG(dev_h2_candidates_t,
  velo_fill_candidates::dev_h2_candidates_t,
  velo_search_by_triplet::dev_h2_candidates_t)
ARG(dev_tracks_t,
...
ARG(dev_tracklets_t,
  velo_search_by_triplet::dev_tracklets_t)
ARG(dev_tracks_to_follow_t,
  velo_search_by_triplet::dev_tracks_to_follow_t)
ARG(dev_weak_tracks_t,
  velo_search_by_triplet::dev_weak_tracks_t,
  velo_weak_tracks_adder::dev_weak_tracks_t)
ARG(dev_hit_used_t,
  velo_search_by_triplet::dev_hit_used_t,
  velo_weak_tracks_adder::dev_hit_used_t)
ARG(dev_atomics_velo_t,
...
ARG(dev_rel_indices_t,
  velo_search_by_triplet::dev_rel_indices_t)
ARG(dev_velo_track_hit_number_t,
...
ARG(dev_accepted_velo_tracks_t,
...
SEQUENCE_T(
  ...
  velo_calculate_phi_and_sort::velo_calculate_phi_and_sort_t<
    std::
      tuple<dev_estimated_input_size_t, dev_module_cluster_num_t, dev_velo_cluster_container_t, dev_hit_permutation_t>>,
