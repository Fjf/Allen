...
struct dev_scifi_lf_initial_windows_t : lf_triplet_keep_best::Parameters::dev_scifi_lf_initial_windows_t,
...
struct dev_scifi_hit_offsets_t : lf_extend_tracks_x::Parameters::dev_scifi_hit_offsets_t,
