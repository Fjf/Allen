...
#include "../../cuda/selections/lines/include/NoBeams.cuh"
#include "../../cuda/selections/lines/include/BeamOne.cuh"
#include "../../cuda/selections/lines/include/BeamTwo.cuh"
#include "../../cuda/selections/lines/include/BothBeams.cuh"
#include "../../cuda/selections/lines/include/ODINNoBias.cuh"
#include "../../cuda/selections/lines/include/ODINLumi.cuh"
#include "../../cuda/selections/lines/include/VeloMicroBias.cuh"
...
#include "../../cuda/selections/lines/include/D2KPi.cuh"
#include "../../cuda/selections/lines/include/D2PiPi.cuh"
#include "../../cuda/selections/lines/include/D2KK.cuh"
...
struct dev_event_list_t : scifi_raw_bank_decoder_v4::Parameters::dev_event_list_t,
...
struct dev_velo_states_t : ut_select_velo_tracks::Parameters::dev_velo_states_t,
...
struct dev_ut_hits_t : ut_find_permutation::Parameters::dev_ut_hits_t,
...
struct dev_offsets_ut_tracks_t : lf_triplet_keep_best::Parameters::dev_offsets_ut_tracks_t,
...
struct dev_offsets_forward_tracks_t : run_hlt1::Parameters::dev_offsets_forward_tracks_t,
                                      host_prefix_sum::Parameters::dev_output_buffer_t,
...
struct dev_scifi_track_ut_indices_t : prepare_decisions::Parameters::dev_scifi_track_ut_indices_t,
...
struct dev_number_of_passing_events_t : prepare_raw_banks::Parameters::dev_number_of_passing_events_t {
  constexpr static auto name {"dev_number_of_passing_events_t"};
  size_t size;
  char* offset;
};
struct dev_passing_event_list_t : prepare_raw_banks::Parameters::dev_passing_event_list_t,
                                  package_sel_reports::Parameters::dev_passing_event_list_t {
...
using configured_sequence_t = std::tuple<
  ...
  prepare_raw_banks::prepare_raw_banks_t<
    std::tuple<
      ...
      dev_sel_rb_substr_t,
      dev_sel_rep_sizes_t,
      dev_number_of_passing_events_t,
