...
#include "../../x86/init_event_list/include/HostInitEventList.h"
...
struct host_event_list_t : host_init_event_list::Parameters::host_event_list_t {
...
struct host_number_of_selected_events_t
  : scifi_raw_bank_decoder_v4::Parameters::host_number_of_selected_events_t,
    ...
    host_init_event_list::Parameters::host_number_of_selected_events_t,
...
struct dev_event_list_t : run_hlt1::Parameters::dev_event_list_t,
                          ...
                          host_init_event_list::Parameters::dev_event_list_t,
...
struct dev_offsets_all_velo_tracks_t : velo_pv_ip::Parameters::dev_offsets_all_velo_tracks_t,
...
struct dev_number_of_multi_fit_vertices_t : kalman_pv_ipchi2::Parameters::dev_number_of_multi_fit_vertices_t,
...
struct dev_offsets_ut_track_hit_number_t : lf_extend_tracks_x::Parameters::dev_offsets_ut_track_hit_number_t,
...
struct dev_scifi_hit_offsets_t : lf_extend_tracks_uv::Parameters::dev_scifi_hit_offsets_t,
...
struct dev_scifi_hits_t : lf_triplet_seeding::Parameters::dev_scifi_hits_t,
...
struct dev_ut_states_t : lf_extend_tracks_uv::Parameters::dev_ut_states_t,
...
struct dev_offsets_forward_tracks_t : FilterTracks::Parameters::dev_offsets_forward_tracks_t,
...
struct dev_scifi_track_ut_indices_t : prepare_raw_banks::Parameters::dev_scifi_track_ut_indices_t,
...
struct dev_storage_tile_id_t : muon_sort_by_station::Parameters::dev_storage_tile_id_t,
...
struct dev_storage_tdc_value_t : muon_pre_decoding::Parameters::dev_storage_tdc_value_t,
...
struct dev_kf_tracks_t : prepare_raw_banks::Parameters::dev_kf_tracks_t,
...
struct dev_sv_offsets_t : run_hlt1::Parameters::dev_sv_offsets_t,
...
using configured_sequence_t = std::tuple<
  ...
  host_init_event_list::host_init_event_list_t<
    std::tuple<host_event_list_t, host_number_of_selected_events_t, dev_event_list_t>,
    'h',
    'o',
    's',
    't',
