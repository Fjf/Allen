...
from AllenConf.validators import velo_validation, seeding_validation, seeding_xz_validation, long_validation, velo_scifi_dump, long_parameters_for_validation
...
matched_tracks = make_velo_scifi_matches(velo_tracks, velo_states,
                                         seeding_tracks)
copied_parameters = long_parameters_for_validation(matched_tracks)
velo_scifi = long_validation(matched_tracks, copied_parameters)
