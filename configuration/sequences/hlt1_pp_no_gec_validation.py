...
host_velo_validator = host_velo_validator_t(name="host_velo_validator",
    ...
    dev_velo_track_hits_t=velo_sequence["velo_consolidate_tracks"].dev_velo_track_hits_t(),
    dev_event_list_t=velo_sequence["initialize_lists"].dev_event_list_t(),
    host_mc_events_t=mc_data_provider.host_mc_events_t())

host_velo_ut_validator = host_velo_ut_validator_t(name="host_velo_ut_validator",
    host_number_of_events_t=velo_sequence["initialize_lists"].host_number_of_events_t(),
    dev_offsets_all_velo_tracks_t=velo_sequence["velo_copy_track_hit_number"].dev_offsets_all_velo_tracks_t(),
    dev_offsets_velo_track_hit_number_t=velo_sequence["prefix_sum_offsets_velo_track_hit_number"].dev_output_buffer_t(),
    dev_velo_track_hits_t=velo_sequence["velo_consolidate_tracks"].dev_velo_track_hits_t(),
    dev_event_list_t=velo_sequence["initialize_lists"].dev_event_list_t(),
    host_mc_events_t=mc_data_provider.host_mc_events_t(),
    dev_velo_kalman_endvelo_states_t=velo_sequence["velo_kalman_filter"].dev_velo_kalman_endvelo_states_t(),
    dev_offsets_ut_tracks_t=ut_sequence["prefix_sum_ut_tracks"].dev_output_buffer_t(),
    dev_offsets_ut_track_hit_number_t=ut_sequence["prefix_sum_ut_track_hit_number"].dev_output_buffer_t(),
    dev_ut_track_hits_t=ut_sequence["ut_consolidate_tracks"].dev_ut_track_hits_t(),
    dev_ut_track_velo_indices_t=ut_sequence["ut_consolidate_tracks"].dev_ut_track_velo_indices_t(),
    dev_ut_qop_t=ut_sequence["ut_consolidate_tracks"].dev_ut_qop_t())

host_forward_validator = host_forward_validator_t(name="host_forward_validator",
    host_number_of_events_t=velo_sequence["initialize_lists"].host_number_of_events_t(),
    dev_offsets_all_velo_tracks_t=velo_sequence["velo_copy_track_hit_number"].dev_offsets_all_velo_tracks_t(),
    dev_offsets_velo_track_hit_number_t=velo_sequence["prefix_sum_offsets_velo_track_hit_number"].dev_output_buffer_t(),
    dev_velo_track_hits_t=velo_sequence["velo_consolidate_tracks"].dev_velo_track_hits_t(),
    ...
    dev_ut_track_velo_indices_t=ut_sequence["ut_consolidate_tracks"].dev_ut_track_velo_indices_t(),
    dev_ut_qop_t=ut_sequence["ut_consolidate_tracks"].dev_ut_qop_t(),
    dev_offsets_forward_tracks_t=forward_sequence["prefix_sum_forward_tracks"].dev_output_buffer_t(),
    dev_offsets_scifi_track_hit_number_t=forward_sequence["prefix_sum_scifi_track_hit_number"].dev_output_buffer_t(),
    dev_scifi_track_hits_t=forward_sequence["scifi_consolidate_tracks_t"].dev_scifi_track_hits_t(),
    dev_scifi_track_ut_indices_t=forward_sequence["scifi_consolidate_tracks_t"].dev_scifi_track_ut_indices_t(),
...
host_muon_validator = host_muon_validator_t(name="host_muon_validator",
    host_number_of_events_t=velo_sequence["initialize_lists"].host_number_of_events_t(),
    dev_offsets_all_velo_tracks_t=velo_sequence["velo_copy_track_hit_number"].dev_offsets_all_velo_tracks_t(),
    dev_offsets_velo_track_hit_number_t=velo_sequence["prefix_sum_offsets_velo_track_hit_number"].dev_output_buffer_t(),
    dev_velo_track_hits_t=velo_sequence["velo_consolidate_tracks"].dev_velo_track_hits_t(),
...
host_kalman_validator = host_kalman_validator_t(name="host_kalman_validator",
    host_number_of_events_t=velo_sequence["initialize_lists"].host_number_of_events_t(),
    dev_offsets_all_velo_tracks_t=velo_sequence["velo_copy_track_hit_number"].dev_offsets_all_velo_tracks_t(),
    dev_offsets_velo_track_hit_number_t=velo_sequence["prefix_sum_offsets_velo_track_hit_number"].dev_output_buffer_t(),
    dev_velo_track_hits_t=velo_sequence["velo_consolidate_tracks"].dev_velo_track_hits_t(),
    dev_event_list_t=velo_sequence["initialize_lists"].dev_event_list_t(),
    host_mc_events_t=mc_data_provider.host_mc_events_t(),
    dev_velo_kalman_states_t=velo_sequence["velo_kalman_filter"].dev_velo_kalman_endvelo_states_t(),
    dev_offsets_ut_tracks_t=ut_sequence["prefix_sum_ut_tracks"].dev_output_buffer_t(),
    dev_offsets_ut_track_hit_number_t=ut_sequence["prefix_sum_ut_track_hit_number"].dev_output_buffer_t(),
    dev_ut_track_hits_t=ut_sequence["ut_consolidate_tracks"].dev_ut_track_hits_t(),
    dev_ut_track_velo_indices_t=ut_sequence["ut_consolidate_tracks"].dev_ut_track_velo_indices_t(),
...
validation_sequence = Sequence(mc_data_provider, host_velo_validator, host_velo_ut_validator, host_forward_validator, 
    host_muon_validator, host_pv_validator, host_rate_validator, host_kalman_validator)
