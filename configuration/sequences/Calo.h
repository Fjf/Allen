...
struct host_number_of_selected_events_t : calo_count_hits::Parameters::host_number_of_selected_events_t, calo_get_digits::Parameters::host_number_of_selected_events_t, host_global_event_cut::Parameters::host_number_of_selected_events_t, calo_find_clusters::Parameters::host_number_of_selected_events_t { constexpr static auto name {"host_number_of_selected_events_t"}; size_t size; char* offset; };
struct dev_event_list_t : host_global_event_cut::Parameters::dev_event_list_t, calo_get_digits::Parameters::dev_event_list_t, calo_find_clusters::Parameters::dev_event_list_t, calo_count_hits::Parameters::dev_event_list_t { constexpr static auto name {"dev_event_list_t"}; size_t size; char* offset; };
struct dev_ecal_raw_input_t : calo_get_digits::Parameters::dev_ecal_raw_input_t, calo_count_hits::Parameters::dev_ecal_raw_input_t { constexpr static auto name {"dev_ecal_raw_input_t"}; size_t size; char* offset; };
struct dev_ecal_raw_input_offsets_t : calo_get_digits::Parameters::dev_ecal_raw_input_offsets_t, calo_count_hits::Parameters::dev_ecal_raw_input_offsets_t { constexpr static auto name {"dev_ecal_raw_input_offsets_t"}; size_t size; char* offset; };
struct dev_ecal_number_of_hits_t : calo_count_hits::Parameters::dev_ecal_number_of_hits_t, host_prefix_sum::Parameters::dev_input_buffer_t { constexpr static auto name {"dev_ecal_number_of_hits_t"}; size_t size; char* offset; };
...
struct dev_hcal_raw_input_offsets_t : calo_count_hits::Parameters::dev_hcal_raw_input_offsets_t, calo_get_digits::Parameters::dev_hcal_raw_input_offsets_t { constexpr static auto name {"dev_hcal_raw_input_offsets_t"}; size_t size; char* offset; };
...
struct host_number_of_ecal_hits_t : calo_find_clusters::Parameters::host_number_of_ecal_hits_t, host_prefix_sum::Parameters::host_total_sum_holder_t, calo_get_digits::Parameters::host_number_of_ecal_hits_t { constexpr static auto name {"host_number_of_ecal_hits_t"}; size_t size; char* offset; };
struct dev_ecal_hits_offsets_t : calo_get_digits::Parameters::dev_ecal_hits_offsets_t, calo_find_clusters::Parameters::dev_ecal_hits_offsets_t, host_prefix_sum::Parameters::dev_output_buffer_t { constexpr static auto name {"dev_ecal_hits_offsets_t"}; size_t size; char* offset; };
struct host_number_of_hcal_hits_t : host_prefix_sum::Parameters::host_total_sum_holder_t, calo_get_digits::Parameters::host_number_of_hcal_hits_t, calo_find_clusters::Parameters::host_number_of_hcal_hits_t { constexpr static auto name {"host_number_of_hcal_hits_t"}; size_t size; char* offset; };
struct dev_hcal_hits_offsets_t : calo_find_clusters::Parameters::dev_hcal_hits_offsets_t, calo_get_digits::Parameters::dev_hcal_hits_offsets_t, host_prefix_sum::Parameters::dev_output_buffer_t { constexpr static auto name {"dev_hcal_hits_offsets_t"}; size_t size; char* offset; };
...
struct dev_hcal_digits_t : calo_get_digits::Parameters::dev_hcal_digits_t, calo_find_clusters::Parameters::dev_hcal_digits_t { constexpr static auto name {"dev_hcal_digits_t"}; size_t size; char* offset; };
...
using configured_sequence_t = std::tuple<
  ...
  calo_find_clusters::calo_find_clusters_t<std::tuple<host_number_of_selected_events_t, host_number_of_ecal_hits_t, host_number_of_hcal_hits_t, dev_event_list_t, dev_ecal_hits_offsets_t, dev_ecal_digits_t, dev_hcal_hits_offsets_t, dev_hcal_digits_t>, 'c', 'a', 'l', 'o', '_', 'f', 'i', 'n', 'd', '_', 'c', 'l', 'u', 's', 't', 'e', 'r', 's', '_', 't'>
>;
