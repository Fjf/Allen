...
struct host_number_of_selected_events_t : calo_find_clusters::Parameters::host_number_of_selected_events_t, calo_find_local_maxima::Parameters::host_number_of_selected_events_t, calo_get_digits::Parameters::host_number_of_selected_events_t, calo_set_cluster_centers::Parameters::host_number_of_selected_events_t, host_global_event_cut::Parameters::host_number_of_selected_events_t { constexpr static auto name {"host_number_of_selected_events_t"}; size_t size; char* offset; };
struct dev_event_list_t : calo_set_cluster_centers::Parameters::dev_event_list_t, calo_get_digits::Parameters::dev_event_list_t, calo_find_clusters::Parameters::dev_event_list_t, host_global_event_cut::Parameters::dev_event_list_t, calo_find_local_maxima::Parameters::dev_event_list_t { constexpr static auto name {"dev_event_list_t"}; size_t size; char* offset; };
...
struct dev_ecal_digits_t : calo_find_local_maxima::Parameters::dev_ecal_digits_t, calo_set_cluster_centers::Parameters::dev_ecal_digits_t, calo_find_clusters::Parameters::dev_ecal_digits_t, calo_get_digits::Parameters::dev_ecal_digits_t { constexpr static auto name {"dev_ecal_digits_t"}; size_t size; char* offset; };
...
struct host_ecal_number_of_clusters_t : calo_find_clusters::Parameters::host_ecal_number_of_clusters_t, calo_set_cluster_centers::Parameters::host_ecal_number_of_clusters_t, host_prefix_sum::Parameters::host_total_sum_holder_t { constexpr static auto name {"host_ecal_number_of_clusters_t"}; size_t size; char* offset; };
struct dev_ecal_cluster_offsets_t : calo_set_cluster_centers::Parameters::dev_ecal_cluster_offsets_t, host_prefix_sum::Parameters::dev_output_buffer_t, calo_find_clusters::Parameters::dev_ecal_cluster_offsets_t { constexpr static auto name {"dev_ecal_cluster_offsets_t"}; size_t size; char* offset; };
struct host_hcal_number_of_clusters_t : calo_find_clusters::Parameters::host_hcal_number_of_clusters_t, calo_set_cluster_centers::Parameters::host_hcal_number_of_clusters_t, host_prefix_sum::Parameters::host_total_sum_holder_t { constexpr static auto name {"host_hcal_number_of_clusters_t"}; size_t size; char* offset; };
struct dev_hcal_cluster_offsets_t : host_prefix_sum::Parameters::dev_output_buffer_t, calo_find_clusters::Parameters::dev_hcal_cluster_offsets_t, calo_set_cluster_centers::Parameters::dev_hcal_cluster_offsets_t { constexpr static auto name {"dev_hcal_cluster_offsets_t"}; size_t size; char* offset; };
struct dev_ecal_clusters_t : calo_find_clusters::Parameters::dev_ecal_clusters_t, calo_set_cluster_centers::Parameters::dev_ecal_clusters_t { constexpr static auto name {"dev_ecal_clusters_t"}; size_t size; char* offset; };
