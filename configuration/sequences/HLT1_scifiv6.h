...
struct dev_scifi_raw_input_t : scifi_pre_decode_v6::Parameters::dev_scifi_raw_input_t,
                               scifi_calculate_cluster_count_v6::Parameters::dev_scifi_raw_input_t,
                               scifi_raw_bank_decoder_v6::Parameters::dev_scifi_raw_input_t {
  constexpr static auto name {"dev_scifi_raw_input_t"};
  size_t size;
  char* offset;
};
struct dev_scifi_raw_input_offsets_t : scifi_calculate_cluster_count_v6::Parameters::dev_scifi_raw_input_offsets_t,
...
struct dev_scifi_hit_offsets_t : scifi_pre_decode_v6::Parameters::dev_scifi_hit_offsets_t,
