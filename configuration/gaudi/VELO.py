...
host_global_event_cut = Algorithm(host_global_event_cut_t,
...
velo_calculate_number_of_candidates = Algorithm(velo_calculate_number_of_candidates_t,
    ...
    host_number_of_selected_events_t = host_global_event_cut.host_number_of_selected_events_t,
    dev_event_list_t = host_global_event_cut.dev_event_list_t)
...
velo_consolidate_tracks.configuration().apply()
