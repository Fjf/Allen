...
def decode_velo(doGEC = True):
    ...
    velo_estimate_input_size = Algorithm(velo_estimate_input_size_t,
    ...
    velo_masked_clustering = Algorithm(velo_masked_clustering_t,
    ...
    return (velo_masked_clustering.dev_module_cluster_num_t, velo_masked_clustering.dev_velo_cluster_container_t)


def make_velo_tracks(doGEC = True):
    host_number_of_selected_events, dev_event_list = initialize_lists(doGEC)
    dev_module_cluster_num, dev_velo_cluster_container = decode_velo(doGEC)
    ...
    velo_three_hit_tracks_filter = Algorithm(velo_three_hit_tracks_filter_t,
    ...
    prefix_sum_offsets_number_of_three_hit_tracks_filtered = Algorithm(host_prefix_sum_t,
    ...
    velo_copy_track_hit_number = Algorithm(velo_copy_track_hit_number_t,
        name = "velo_copy_track_hit_number",
        host_number_of_selected_events_t = host_number_of_selected_events,
        host_number_of_velo_tracks_at_least_four_hits_t = prefix_sum_offsets_velo_tracks.host_total_sum_holder_t,
        host_number_of_three_hit_tracks_filtered_t = prefix_sum_offsets_number_of_three_hit_tracks_filtered.host_total_sum_holder_t,
        dev_tracks_t = velo_search_by_triplet.dev_tracks_t,
        dev_offsets_velo_tracks_t = prefix_sum_offsets_velo_tracks.dev_output_buffer_t,
    ...
    prefix_sum_offsets_velo_track_hit_number = Algorithm(host_prefix_sum_t,
        name = "prefix_sum_offsets_velo_track_hit_number",
        dev_input_buffer_t = velo_copy_track_hit_number.dev_velo_track_hit_number_t)

    velo_consolidate_tracks = Algorithm(velo_consolidate_tracks_t,
        name = "velo_consolidate_tracks",
        host_accumulated_number_of_hits_in_velo_tracks_t = prefix_sum_offsets_velo_track_hit_number.host_total_sum_holder_t,
    ...
    return (velo_consolidate_tracks, velo_consolidate_tracks.dev_velo_track_hits_t, velo_consolidate_tracks.dev_velo_states_t, velo_consolidate_tracks.dev_offsets_all_velo_tracks_t)
