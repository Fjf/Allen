...
def run_selections(**kwargs):
    ...
    velo_pv_ip = Algorithm(velo_pv_ip_t,
        ...
        host_number_of_selected_events_t = initialized_lists["host_number_of_selected_events"],
        ...
        dev_number_of_multi_fit_vertices_t = pvs["dev_number_of_multi_fit_vertices"])

    kalman_velo_only = Algorithm(kalman_velo_only_t,
        name = "kalman_velo_only",
        host_number_of_selected_events_t = initialized_lists["host_number_of_selected_events"],
        host_number_of_reconstructed_scifi_tracks_t = forward_tracks["host_number_of_reconstructed_scifi_tracks"],
        dev_offsets_all_velo_tracks_t = velo_tracks["dev_offsets_all_velo_tracks"],
        dev_offsets_velo_track_hit_number_t = velo_tracks["dev_offsets_velo_track_hit_number"],
    ...
    filter_tracks = Algorithm(filter_tracks_t,
        name = "filter_tracks",
        host_number_of_selected_events_t = initialized_lists["host_number_of_selected_events"],
    ...
    prefix_sum_secondary_vertices = Algorithm(host_prefix_sum_t,
        name = "prefix_sum_secondary_vertices",
        dev_input_buffer_t = filter_tracks.dev_sv_atomics_t)

    fit_secondary_vertices = Algorithm(fit_secondary_vertices_t,
    ...
    odin_banks = Algorithm(data_provider_t,
        name = "populate_odin_banks",
        bank_type = "ODIN")

    run_hlt1 = Algorithm(run_hlt1_t,
        name = "run_hlt1",
        host_number_of_selected_events_t = initialized_lists["host_number_of_selected_events"],
        host_number_of_reconstructed_scifi_tracks_t = forward_tracks["host_number_of_reconstructed_scifi_tracks"],
        host_number_of_svs_t = prefix_sum_secondary_vertices.host_total_sum_holder_t,
    ...
    prefix_sum_sel_reps = Algorithm(host_prefix_sum_t,
        name = "prefix_sum_sel_reps",
        dev_input_buffer_t = prepare_raw_banks.dev_sel_rep_sizes_t)

    package_sel_reports = Algorithm(package_sel_reports_t,
        name = "package_sel_reports",
        host_number_of_selected_events_t = initialized_lists["host_number_of_selected_events"],
        host_number_of_sel_rep_words_t = prefix_sum_sel_reps.host_total_sum_holder_t,
        dev_event_list_t = initialized_lists["dev_event_list"],
        dev_offsets_forward_tracks_t = forward_tracks["dev_offsets_forward_tracks"],
    ...
    return {"dev_sel_rep_raw_banks": package_sel_reports.dev_sel_rep_raw_banks_t}
