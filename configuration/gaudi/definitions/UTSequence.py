...
def UTSequence(initialize_lists,
    ...
    ut_calculate_number_of_hits = Algorithm(ut_calculate_number_of_hits_t,
    ...
    ut_find_permutation = Algorithm(ut_find_permutation_t,
    ...
    ut_decode_raw_banks_in_order = Algorithm(ut_decode_raw_banks_in_order_t,
        ...
        dev_ut_hit_offsets_t = prefix_sum_ut_hits.dev_output_buffer_t,
        dev_ut_pre_decoded_hits_t = ut_pre_decode.dev_ut_pre_decoded_hits_t,
        dev_ut_hit_permutations_t = ut_find_permutation.dev_ut_hit_permutations_t)

    ut_select_velo_tracks = Algorithm(ut_select_velo_tracks_t,
        name = "ut_select_velo_tracks",
        host_number_of_selected_events_t = initialize_lists.host_number_of_selected_events_t,
        host_number_of_reconstructed_velo_tracks_t = velo_copy_track_hit_number.host_number_of_reconstructed_velo_tracks_t,
        ...
        dev_accepted_velo_tracks_t = velo_consolidate_tracks.dev_accepted_velo_tracks_t)

    ut_search_windows = None
    compass_ut = None
    if restricted:
        ut_search_windows = Algorithm(ut_search_windows_t,
            ...
            dev_offsets_velo_track_hit_number_t = prefix_sum_offsets_velo_track_hit_number.dev_output_buffer_t,
            dev_velo_states_t = velo_consolidate_tracks.dev_velo_states_t,
            dev_ut_number_of_selected_velo_tracks_t = ut_select_velo_tracks.dev_ut_number_of_selected_velo_tracks_t,
            dev_ut_selected_velo_tracks_t = ut_select_velo_tracks.dev_ut_selected_velo_tracks_t,
            min_momentum = "1500.0",
            min_pt = "300.0")

        ut_select_velo_tracks_with_windows = Algorithm(ut_select_velo_tracks_with_windows_t,
        ...
        compass_ut = Algorithm(compass_ut_t,
            name = "compass_ut",
            host_number_of_selected_events_t = initialize_lists.host_number_of_selected_events_t,
            dev_ut_hits_t = ut_decode_raw_banks_in_order.dev_ut_hits_t,
            dev_ut_hit_offsets_t = prefix_sum_ut_hits.dev_output_buffer_t,
            ...
            dev_velo_states_t = velo_consolidate_tracks.dev_velo_states_t,
            dev_ut_windows_layers_t = ut_search_windows.dev_ut_windows_layers_t,
            dev_ut_number_of_selected_velo_tracks_with_windows_t = ut_select_velo_tracks_with_windows.dev_ut_number_of_selected_velo_tracks_with_windows_t,
            dev_ut_selected_velo_tracks_with_windows_t = ut_select_velo_tracks_with_windows.dev_ut_selected_velo_tracks_with_windows_t,
    ...
    prefix_sum_ut_tracks = Algorithm(host_prefix_sum_t,
        name = "prefix_sum_ut_tracks",
        dev_input_buffer_t = compass_ut.dev_atomics_ut_t)

    ut_copy_track_hit_number = Algorithm(ut_copy_track_hit_number_t,
    ...
    prefix_sum_ut_track_hit_number = Algorithm(host_prefix_sum_t,
        name = "prefix_sum_ut_track_hit_number",
        dev_input_buffer_t = ut_copy_track_hit_number.dev_ut_track_hit_number_t)

    ut_consolidate_tracks = Algorithm(ut_consolidate_tracks_t,
        name = "ut_consolidate_tracks",
        host_accumulated_number_of_ut_hits_t = prefix_sum_ut_hits.host_total_sum_holder_t,
        host_number_of_reconstructed_ut_tracks_t = prefix_sum_ut_tracks.host_total_sum_holder_t,
        host_number_of_selected_events_t = initialize_lists.host_number_of_selected_events_t,
        host_accumulated_number_of_hits_in_ut_tracks_t = prefix_sum_ut_track_hit_number.host_total_sum_holder_t,
        dev_ut_hits_t = ut_decode_raw_banks_in_order.dev_ut_hits_t,
        dev_ut_hit_offsets_t = prefix_sum_ut_hits.dev_output_buffer_t,
        dev_offsets_ut_tracks_t = prefix_sum_ut_tracks.dev_output_buffer_t,
    ...
    ut_sequence_dict = algorithm_dict(
