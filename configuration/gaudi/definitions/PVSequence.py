...
def run_velo_kalman_filter(**kwargs):
  ...
  velo_kalman_filter = Algorithm(velo_kalman_filter_t,
  ...
  return {"dev_velo_kalman_beamline_states": velo_kalman_filter.dev_velo_kalman_beamline_states_t}
...
def make_pvs(**kwargs):
    ...
    pv_beamline_histo = Algorithm(pv_beamline_histo_t,
    ...
    pv_beamline_peak = Algorithm(pv_beamline_peak_t,
      name = "pv_beamline_peak",
      host_number_of_selected_events_t = host_number_of_selected_events,
      dev_zhisto_t = pv_beamline_histo.dev_zhisto_t)
    
    pv_beamline_calculate_denom = Algorithm(pv_beamline_calculate_denom_t,
    ...
    pv_beamline_multi_fitter = Algorithm(pv_beamline_multi_fitter_t,
    ...
    pv_beamline_cleanup = Algorithm(pv_beamline_cleanup_t,
