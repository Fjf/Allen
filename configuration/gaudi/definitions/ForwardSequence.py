...
def make_forward_tracks(forward_decoding="v4", **kwargs):
    ...
    host_number_of_reconstructed_ut_tracks = ut_tracks["host_number_of_reconstructed_ut_tracks"]
    dev_offsets_ut_tracks = ut_tracks["dev_offsets_ut_tracks"]
    dev_offsets_ut_track_hit_number = ut_tracks["dev_offsets_ut_track_hit_number"]
    ...
    scifi_banks = Algorithm(data_provider_t,
        name = "scifi_banks",
        bank_type = "FTCluster")
    ...
    scifi_calculate_cluster_count = Algorithm(scifi_calculate_cluster_count_algorithm,
    ...
    prefix_sum_scifi_hits = Algorithm(host_prefix_sum_t,
        name = "prefix_sum_scifi_hits",
        dev_input_buffer_t = scifi_calculate_cluster_count.dev_scifi_hit_count_t)

    scifi_pre_decode = Algorithm(scifi_pre_decode_algorithm,
    ...
    scifi_raw_bank_decoder = Algorithm(scifi_raw_bank_decoder_algorithm,
    ...
    lf_search_initial_windows = Algorithm(lf_search_initial_windows_t,
        name = "lf_search_initial_windows",
        host_number_of_selected_events_t = host_number_of_selected_events,
        host_number_of_reconstructed_ut_tracks_t = host_number_of_reconstructed_ut_tracks,
    ...
    lf_triplet_seeding = Algorithm(lf_triplet_seeding_t,
    ...
    lf_create_tracks = Algorithm(lf_create_tracks_t,
    ...
    lf_quality_filter_length = Algorithm(lf_quality_filter_length_t,
    ...
    lf_quality_filter = Algorithm(lf_quality_filter_t,
    ...
    prefix_sum_forward_tracks = Algorithm(host_prefix_sum_t,
        name = "prefix_sum_forward_tracks",
        dev_input_buffer_t = lf_quality_filter.dev_atomics_scifi_t)

    scifi_copy_track_hit_number = Algorithm(scifi_copy_track_hit_number_t,
    ...
    prefix_sum_scifi_track_hit_number = Algorithm(host_prefix_sum_t,
        name = "prefix_sum_scifi_track_hit_number",
        dev_input_buffer_t = scifi_copy_track_hit_number.dev_scifi_track_hit_number_t)

    scifi_consolidate_tracks = Algorithm(scifi_consolidate_tracks_t,
    ...
    return {"dev_scifi_track_hits": scifi_consolidate_tracks.dev_scifi_track_hits_t,
            ...
            "host_number_of_reconstructed_scifi_tracks": prefix_sum_forward_tracks.host_total_sum_holder_t,
            "dev_offsets_forward_tracks": prefix_sum_forward_tracks.dev_output_buffer_t,
