...
###############################################################################
from AllenCore.algorithms import single_calo_cluster_line_t, two_calo_clusters_line_t, two_calo_clusters_standalone_line_t
...
def make_standalone_pi0_line(calo,
                            ...
                            minSumEt_clusters=0,
                            minE19_clusters=0.6,
                            minTransverseDistance=200,
                            #histogram_pi0_mass_max=500,
                            enable_monitoring=False):
    number_of_events = initialize_number_of_events()
    odin = decode_odin()
    layout = mep_layout()
    ...
    return make_algorithm(
        two_calo_clusters_standalone_line_t,
        name=name,
        host_number_of_events_t=number_of_events["host_number_of_events"],
        pre_scaler_hash_string=pre_scaler_hash_string or name + "_pre",
        post_scaler_hash_string=post_scaler_hash_string or name + "_post",
        ...
        maxMass=maxMass,  #MeV
        minEt=minEt,
        minEt_clusters=minEt_clusters,
        minSumEt_clusters=minSumEt_clusters,
