...
def make_sel_report_writer(lines, forward_tracks, secondary_vertices):
    ...
    return [
        count_long_track_hits, prefix_sum_long_track_hits, make_hits_container,
        ...
        prefix_sum_substr_size, prefix_sum_stdinfo_size,
        prefix_sum_candidate_count, make_rb_hits, make_rb_substr,
        make_rb_stdinfo, make_rb_objtyp, calc_selrep_size,
