...
static_assert(
  all_host_or_all_device_v<ut_consolidate_tracks__dev_ut_qop_t, ut_consolidate_tracks::Parameters::dev_ut_qop_t>);
static_assert(
  all_host_or_all_device_v<ut_consolidate_tracks__dev_ut_x_t, ut_consolidate_tracks::Parameters::dev_ut_x_t>);
static_assert(
  all_host_or_all_device_v<ut_consolidate_tracks__dev_ut_tx_t, ut_consolidate_tracks::Parameters::dev_ut_tx_t>);
static_assert(
  all_host_or_all_device_v<ut_consolidate_tracks__dev_ut_z_t, ut_consolidate_tracks::Parameters::dev_ut_z_t>);
static_assert(all_host_or_all_device_v<
