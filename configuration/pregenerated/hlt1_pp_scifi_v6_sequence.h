...
struct initialize_lists__dev_number_of_events_t
  : host_global_event_cut::Parameters::dev_number_of_events_t,
    ...
    scifi_raw_bank_decoder_v6::Parameters::dev_number_of_events_t,
...
struct scifi_calculate_cluster_count_v6_t__dev_scifi_hit_count_t
  : scifi_calculate_cluster_count_v6::Parameters::dev_scifi_hit_count_t,
    host_prefix_sum::Parameters::dev_input_buffer_t {
  using type = scifi_calculate_cluster_count_v6::Parameters::dev_scifi_hit_count_t::type;
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
...
struct scifi_pre_decode_v6_t__dev_cluster_references_t
  ...
  using type = scifi_pre_decode_v6::Parameters::dev_cluster_references_t::type;
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
...
struct scifi_raw_bank_decoder_v6_t__dev_scifi_hits_t : scifi_raw_bank_decoder_v6::Parameters::dev_scifi_hits_t,
  ...
  using type = scifi_raw_bank_decoder_v6::Parameters::dev_scifi_hits_t::type;
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
...
struct gather_selections__dev_number_of_active_lines_t : gather_selections::Parameters::dev_number_of_active_lines_t,
  ...
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "gather_selections__dev_number_of_active_lines_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
struct gather_selections__host_post_scale_factors_t : gather_selections::Parameters::host_post_scale_factors_t {
  ...
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "gather_selections__host_post_scale_factors_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
struct gather_selections__host_post_scale_hashes_t : gather_selections::Parameters::host_post_scale_hashes_t {
  ...
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "gather_selections__host_post_scale_hashes_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
struct gather_selections__dev_post_scale_factors_t : gather_selections::Parameters::dev_post_scale_factors_t {
  ...
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "gather_selections__dev_post_scale_factors_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
struct gather_selections__dev_post_scale_hashes_t : gather_selections::Parameters::dev_post_scale_hashes_t {
  ...
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "gather_selections__dev_post_scale_hashes_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
struct dec_reporter__dev_dec_reports_t : dec_reporter::Parameters::dev_dec_reports_t {
  ...
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "dec_reporter__dev_dec_reports_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
void inline populate_sequence_algorithm_names(configured_sequence_t& sequence)
{
  ...
  std::get<68>(sequence).set_name("track_mva_line");
  std::get<69>(sequence).set_name("two_track_mva_line");
  std::get<70>(sequence).set_name("no_beam_line");
  std::get<71>(sequence).set_name("beam_one_line");
  std::get<72>(sequence).set_name("beam_two_line");
  std::get<73>(sequence).set_name("both_beams_line");
  std::get<74>(sequence).set_name("velo_micro_bias_line");
  std::get<75>(sequence).set_name("odin_lumi_line");
  std::get<76>(sequence).set_name("odin_no_bias");
  std::get<77>(sequence).set_name("single_high_pt_muon_line");
  std::get<78>(sequence).set_name("low_pt_muon_line");
  std::get<79>(sequence).set_name("d2kk_line");
  std::get<80>(sequence).set_name("d2kpi_line");
  std::get<81>(sequence).set_name("d2pipi_line");
  std::get<82>(sequence).set_name("di_muon_high_mass_line");
  std::get<83>(sequence).set_name("di_muon_low_mass_line");
  std::get<84>(sequence).set_name("di_muon_soft_line");
  std::get<85>(sequence).set_name("low_pt_di_muon_line");
  std::get<86>(sequence).set_name("track_muon_mva_line");
  std::get<87>(sequence).set_name("gec_passthrough_line");
  std::get<88>(sequence).set_name("passthrough_line");
