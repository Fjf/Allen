...
struct initialize_lists__host_number_of_events_t
  : host_global_event_cut::Parameters::host_number_of_events_t,
    ...
    scifi_calculate_cluster_count_v6::Parameters::host_number_of_events_t,
    scifi_pre_decode_v6::Parameters::host_number_of_events_t,
    scifi_raw_bank_decoder_v6::Parameters::host_number_of_events_t,
    ...
    run_hlt1::Parameters::host_number_of_events_t,
    prepare_raw_banks::Parameters::host_number_of_events_t,
    package_sel_reports::Parameters::host_number_of_events_t {
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
...
struct scifi_calculate_cluster_count_v6_t__dev_scifi_hit_count_t
  ...
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "scifi_calculate_cluster_count_v6_t__dev_scifi_hit_count_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
struct prefix_sum_scifi_hits__host_total_sum_holder_t
  : host_prefix_sum::Parameters::host_total_sum_holder_t,
    ...
    scifi_raw_bank_decoder_v6::Parameters::host_accumulated_number_of_scifi_hits_t {
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
...
struct scifi_pre_decode_v6_t__dev_cluster_references_t
  : scifi_pre_decode_v6::Parameters::dev_cluster_references_t,
    scifi_raw_bank_decoder_v6::Parameters::dev_cluster_references_t {
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "scifi_pre_decode_v6_t__dev_cluster_references_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
struct scifi_raw_bank_decoder_v6_t__dev_scifi_hits_t : scifi_raw_bank_decoder_v6::Parameters::dev_scifi_hits_t,
  ...
  void set_size(size_t size) override { m_size = size; }
  size_t size() const override { return m_size; }
  std::string name() const override { return "scifi_raw_bank_decoder_v6_t__dev_scifi_hits_t"; }
  void set_offset(char* offset) override { m_offset = offset; }
  char* offset() const override { return m_offset; }
...
void inline populate_sequence_algorithm_names(configured_sequence_t& sequence)
{
  ...
  std::get<39>(sequence).set_name("scifi_calculate_cluster_count_v6_t");
  std::get<40>(sequence).set_name("prefix_sum_scifi_hits");
  std::get<41>(sequence).set_name("scifi_pre_decode_v6_t");
  std::get<42>(sequence).set_name("scifi_raw_bank_decoder_v6_t");
  ...
  std::get<60>(sequence).set_name("velo_pv_ip_t");
  std::get<61>(sequence).set_name("kalman_velo_only_t");
  std::get<62>(sequence).set_name("filter_tracks_t");
  std::get<63>(sequence).set_name("prefix_sum_secondary_vertices");
  std::get<64>(sequence).set_name("fit_secondary_vertices_t");
  std::get<65>(sequence).set_name("populate_odin_banks");
  std::get<66>(sequence).set_name("run_hlt1_t");
  std::get<67>(sequence).set_name("prepare_raw_banks_t");
  std::get<68>(sequence).set_name("prefix_sum_sel_reps");
  std::get<69>(sequence).set_name("package_sel_reports_t");
}
