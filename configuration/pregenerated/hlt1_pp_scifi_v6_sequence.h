...
void populate_sequence_argument_names(T& argument_manager)
{
  ...
  argument_manager.template set_name<scifi_calculate_cluster_count_v6_t__dev_scifi_hit_count_t>(
    "scifi_calculate_cluster_count_v6_t__dev_scifi_hit_count_t");
  ...
  argument_manager.template set_name<prefix_sum_scifi_hits__dev_output_buffer_t>(
    "prefix_sum_scifi_hits__dev_output_buffer_t");
  argument_manager.template set_name<scifi_pre_decode_v6_t__dev_cluster_references_t>(
    "scifi_pre_decode_v6_t__dev_cluster_references_t");
  argument_manager.template set_name<scifi_raw_bank_decoder_v6_t__dev_scifi_hits_t>(
    "scifi_raw_bank_decoder_v6_t__dev_scifi_hits_t");
