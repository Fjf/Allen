...
void inline populate_sequence_algorithm_names(configured_sequence_t& sequence)
{
  ...
  std::get<40>(sequence).set_name("scifi_calculate_cluster_count_v6_t");
  std::get<41>(sequence).set_name("prefix_sum_scifi_hits");
  std::get<42>(sequence).set_name("scifi_pre_decode_v6_t");
  std::get<43>(sequence).set_name("scifi_raw_bank_decoder_v6_t");
