...
def Forward_sequence(validate=True):
  ...
  prefix_sum_forward_tracks = host_prefix_sum_t("prefix_sum_forward_tracks",
  ...
  prefix_sum_scifi_track_hit_number = host_prefix_sum_t("prefix_sum_scifi_track_hit_number",
    host_total_sum_holder_t="host_accumulated_number_of_hits_in_scifi_tracks_t",
