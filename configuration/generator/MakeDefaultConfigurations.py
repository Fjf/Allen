...
muon_sequence = compose_sequences(VELO_sequence(), PV_sequence(), UT_sequence(), Muon_sequence())
muon_sequence.generate(
    output_filename="generated/Muon.h",
    json_configuration_filename="generated/Muon.json")

forward_sequence = compose_sequences(VELO_sequence(), PV_sequence(), UT_sequence(), Muon_sequence(), Forward_sequence())
forward_sequence.generate(
    output_filename="generated/Forward.h",
    json_configuration_filename="generated/Forward.json")

hlt1_sequence = compose_sequences(VELO_sequence(), PV_sequence(), UT_sequence(), Muon_sequence(), Forward_sequence(), HLT1_sequence())
...
hlt1_noutcut_sequence = compose_sequences(VELO_sequence(), PV_sequence(), UT_sequence(restricted=False), Muon_sequence(), Forward_sequence(), HLT1_sequence())
