...
def Muon_sequence(validate=True):
  muon_pre_decoding = muon_pre_decoding_t()

  muon_pre_decoding_prefix_sum = host_prefix_sum_t("muon_pre_decoding_prefix_sum",
    host_total_sum_holder_t="host_muon_total_number_of_tiles_t",
    dev_input_buffer_t=muon_pre_decoding.dev_storage_station_region_quarter_sizes_t(),
  ...
  muon_station_ocurrence_prefix_sum = host_prefix_sum_t("muon_station_ocurrence_prefix_sum",
