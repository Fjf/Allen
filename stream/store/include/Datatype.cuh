...
#define DEVICE_INPUT_OPTIONAL(ARGUMENT_NAME, ...)                                                 \
  struct ARGUMENT_NAME : public Allen::Store::device_datatype, Allen::Store::optional_datatype, Allen::Store::input_datatype<__VA_ARGS__> { \
    using Allen::Store::input_datatype<__VA_ARGS__>::input_datatype;                                            \
    void parameter(__VA_ARGS__) const;                                                            \
  }

#define HOST_INPUT_OPTIONAL(ARGUMENT_NAME, ...)                                                 \
  struct ARGUMENT_NAME : public Allen::Store::host_datatype, Allen::Store::optional_datatype, Allen::Store::input_datatype<__VA_ARGS__> { \
    using Allen::Store::input_datatype<__VA_ARGS__>::input_datatype;                                          \
    void parameter(__VA_ARGS__) const;                                                          \
  }
