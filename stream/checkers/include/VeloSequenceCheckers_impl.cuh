...
//   static void
//   check(HostBuffers&, const Constants&, const CheckerInvoker&, MCEvents const&)
//   {
...
//     // // Default value for root_output_name_t: "PrCheckerPlots.root"
//     // auto& checker = checker_invoker.checker<TrackCheckerVelo>(name(), property<root_output_name_t>());
