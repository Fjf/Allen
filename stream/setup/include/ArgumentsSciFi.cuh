...
ARGUMENT(dev_scifi_lf_triplet_best, float)
...
ARGUMENT(dev_scifi_lf_active_ut_tracks, uint)
ARGUMENT(dev_scifi_lf_number_of_active_ut_tracks, uint)
ARGUMENT(dev_scifi_lf_parametrization, float)
ARGUMENT(dev_scifi_lf_parametrization_x_filter, float)
ARGUMENT(dev_scifi_lf_collected_hits_atomics, uint)
ARGUMENT(dev_scifi_lf_collected_hits_tracks, uint)
ARGUMENT(dev_scifi_lf_process_track, bool)
ARGUMENT(dev_scifi_lf_found_triplets, int16_t)
ARGUMENT(dev_scifi_lf_number_of_found_triplets, int16_t)
ARGUMENT(dev_scifi_lf_total_number_of_found_triplets, uint)
ARGUMENT(dev_scifi_lf_parametrization_length_filter, float)
ARGUMENT(dev_scifi_lf_y_parametrization_length_filter, float)
ARGUMENT(dev_scifi_lf_parametrization_consolidate, float)