...
measurements = {
    "GeForce GTX 670" : {5.26, 5.44, 5.05, 5.41, 5.37, 5.27, 5.23, 5.34, 5.34, 5.41},
    "GeForce GTX 680" : {5.47, 5.66, 5.26, 5.63, 5.56, 5.52, 5.48, 5.54, 5.53, 5.66},
    "GeForce GTX 1060 6GB" : {12.17, 12.61, 11.75, 12.42, 12.28, 12.07, 11.95, 12.32, 12.31, 12.27},
    "GeForce GTX TITAN X" : {17.98, 18.73, 17.19, 18.17, 18.03, 17.74, 17.56, 18.21, 17.92, 18.18},
    "GeForce GTX 1080 Ti" : {28.70, 29.84, 27.46, 28.97, 28.77, 28.28, 28.04, 29.15, 28.61, 29.02},
    "Tesla T4" : {37.86, 39.38, 36.33, 38.23, 37.95, 37.32, 36.76, 38.41, 37.81, 38.31},
    "GeForce RTX 2080 Ti" : {71.30, 73.84, 68.20, 71.92, 71.64, 70.28, 69.83, 72.38, 70.98, 72.14},
    "Quadro RTX 6000" : {75.10, 77.69, 72.17, 76.03, 75.59, 74.68, 73.82, 76.29, 75.05, 76.07},
    "Tesla V100 32GB" : {79.32, 82.30, 76.32, 80.43, 70.90, 78.73, 77.70, 80.55, 79.43, 80.23}
}
throughput = []
errors = []
for label in labels:
