...
struct scifi_pre_decode_v6_t : public GpuAlgorithm {
  constexpr static auto name {"scifi_pre_decode_v6_t"};
  decltype(gpu_function(scifi_pre_decode_v6)) function {scifi_pre_decode_v6};
