...
struct ubiq_type_helper {
    using t = decltype(T{I});
};
...
struct is_aggregate_initializable_n {
    ...
    static constexpr bool is_not_constructible_n(std::index_sequence<I...>) noexcept {
        return (!std::is_constructible<T, typename ubiq_type_helper<ubiq_lref_constructor, I>::t...>::value &&
            !std::is_constructible<T, typename ubiq_type_helper<ubiq_rref_constructor, I>::t...>::value)
