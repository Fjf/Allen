...
void register_consumers(Allen::NonEventData::IUpdater* updater, Constants& constants, const std::unordered_set<BankTypes> requested_banks)
{
  const auto consumers = std::make_tuple(
    std::make_tuple(
      ...
      [&constants] () { return std::make_unique<Consumers::HostDeviceGeometry>(constants.host_ut_boards, constants.dev_ut_boards); },
      BankTypes::UT),
    std::make_tuple(
      ...
      BankTypes::UT),
    std::make_tuple(
      Allen::NonEventData::UTGeometry {}, [&constants] () { return std::make_unique<Consumers::UTGeometry>(constants); }, BankTypes::UT),
    std::make_tuple(
      Allen::NonEventData::SciFiGeometry {},
      [&constants] () { return std::make_unique<Consumers::HostDeviceGeometry>(constants.host_scifi_geometry, constants.dev_scifi_geometry); },
      BankTypes::FT),
    std::make_tuple(
    ...
    std::make_tuple(
      ...
      [&constants] () { return std::make_unique<Consumers::HostDeviceGeometry>(constants.host_ecal_geometry, constants.dev_ecal_geometry); },
      BankTypes::ECal),
    std::make_tuple(
      Allen::NonEventData::MuonGeometry {},
      [&constants] () { return std::make_unique<Consumers::MuonGeometry>(
    ...
    std::make_tuple(
      ...
      [&constants] () { return std::make_unique<Consumers::MuonLookupTables>(
  ...
  const auto unconditional_consumers = std::make_tuple(
    std::make_tuple(
      ...
      [&constants] () { return std::make_unique<Consumers::MagneticField>(constants.dev_magnet_polarity); })
  );
