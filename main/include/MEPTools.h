...
namespace MEP {
  ...
  __preamble__ unsigned int number_of_banks(unsigned int const* offsets) { return offsets[0]; }

  __preamble__ unsigned int offset_index(unsigned int const n_banks, unsigned int const event, unsigned int const bank)
  {
