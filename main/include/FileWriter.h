...
public:
  FileWriter(IInputProvider const* input_provider, std::string filename, size_t const output_batch_size, size_t const n_lines, bool checksum = true) :
    OutputHandler {input_provider, filename, output_batch_size, n_lines, checksum}, m_filename {std::move(filename)}
  {
