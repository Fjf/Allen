...
//    scifi_tracks.qop(i) = event_scifi_tracks[i].qop;
    ...
    const auto txO2 = txO2;
    const auto txO3 = txO3;
    const auto txO4 = txO4;
    const auto txO5 = txO5;
    const auto txO6 = txO6;
    
    const auto C0 = dev_looking_forward_constants->C0[0]+dev_looking_forward_constants->C0[1]*txO2 + dev_looking_forward_constants->C0[2]*txO4 + dev_looking_forward_constants->C0[3]*pow(tyO,2) + dev_looking_forward_constants->C0[4]*pow(tyO,4) + dev_looking_forward_constants->C0[5]*txO2*pow(tyO,2) + dev_looking_forward_constants->C0[6]*txO6 + dev_looking_forward_constants->C0[7]*pow(tyO,5) + dev_looking_forward_constants->C0[8]*txO4*pow(tyO,2) + dev_looking_forward_constants->C0[9]*txO2*pow(tyO,4);
    const auto C1 = dev_looking_forward_constants->C1[0]+dev_looking_forward_constants->C1[1]*txO + dev_looking_forward_constants->C1[2]*txO3 +dev_looking_forward_constants->C1[3]*txO5 +dev_looking_forward_constants->C1[4]*pow(txO,7) + dev_looking_forward_constants->C1[5]*pow(tyO,2) + dev_looking_forward_constants->C1[6]*pow(tyO,4) + dev_looking_forward_constants->C1[7]*pow(tyO,6) + dev_looking_forward_constants->C1[8]*txO*pow(tyO,2) +dev_looking_forward_constants->C1[9]*txO*pow(tyO,4) +dev_looking_forward_constants->C1[10]*txO*pow(tyO,6) +dev_looking_forward_constants->C1[11]*txO3*pow(tyO,2) + dev_looking_forward_constants->C1[12]*txO3*pow(tyO,4) + dev_looking_forward_constants->C1[13]*txO5*pow(tyO,2);
    const auto C2 = dev_looking_forward_constants->C2[0]+dev_looking_forward_constants->C2[1]*txO2 + dev_looking_forward_constants->C2[2]*txO4 + dev_looking_forward_constants->C2[3]*pow(tyO,2) + dev_looking_forward_constants->C2[4]*pow(tyO,4)  + dev_looking_forward_constants->C2[5]*txO2*pow(tyO,2)  + dev_looking_forward_constants->C2[6]*txO6 + dev_looking_forward_constants->C2[7]*pow(tyO,5) + dev_looking_forward_constants->C2[8]*txO4*pow(tyO,2) + dev_looking_forward_constants->C2[9]*txO2*pow(tyO,4);
    const auto C3 = dev_looking_forward_constants->C3[0]+dev_looking_forward_constants->C3[1]*txO + dev_looking_forward_constants->C3[2]*txO3 +dev_looking_forward_constants->C3[3]*txO5 +dev_looking_forward_constants->C3[4]*pow(txO,7) + dev_looking_forward_constants->C3[5]*pow(tyO,2) + dev_looking_forward_constants->C3[6]*pow(tyO,4) + dev_looking_forward_constants->C3[7]*pow(tyO,6) + dev_looking_forward_constants->C3[8]*txO*pow(tyO,2) +dev_looking_forward_constants->C3[9]*txO*pow(tyO,4) +dev_looking_forward_constants->C3[10]*txO*pow(tyO,6) +dev_looking_forward_constants->C3[11]*txO3*pow(tyO,2) + dev_looking_forward_constants->C3[12]*txO3*pow(tyO,4) + dev_looking_forward_constants->C3[13]*txO5*pow(tyO,2);
    const auto C4 = dev_looking_forward_constants->C4[0]+dev_looking_forward_constants->C4[1]*txO2 + dev_looking_forward_constants->C4[2]*txO4 + dev_looking_forward_constants->C4[3]*pow(tyO,2) + dev_looking_forward_constants->C4[4]*pow(tyO,4)  + dev_looking_forward_constants->C4[5]*txO2*pow(tyO,2)  + dev_looking_forward_constants->C4[6]*txO6 + dev_looking_forward_constants->C4[7]*pow(tyO,5) + dev_looking_forward_constants->C4[8]*txO4*pow(tyO,2) + dev_looking_forward_constants->C4[9]*txO2*pow(tyO,4);
