...
namespace Allen {
  ...
  private:
    ...
    const unsigned m_number_of_substructures = 0;
    const unsigned m_index = 0;
    const unsigned m_total_number_of_composites = 0;
  ...
  namespace Views {
    ...
    // private:
    //   const SV::Vertex* m_vertex; // Doesn't exist yet. View of SOA of SV fit results.
    //   const BasicParticle* m_child1;
    //   const BasicParticle* m_child2;
    //   const PV::Vertex* m_pv;
    //   const unsigned m_index;
    // };

    // struct CompositParticle3Track {
    // private:
    //   const SV::Vertex* m_vertex; // Doesn't exist yet. View of SOA of SV fit results.
    //   const CompositParticle2Track* m_composit_child;
    //   const BasicParticle* m_basic_child;
    //   const PV::Vertex* m_pv;
    //   const unsigned m_index;
    // };
