...
namespace velo_copy_track_hit_number {
  DEFINE_PARAMETERS(
    ...
    (HOST_INPUT(host_number_of_velo_tracks_at_least_four_hits_t, uint), host_number_of_velo_tracks_at_least_four_hits),
    (HOST_INPUT(host_number_of_three_hit_tracks_filtered_t, uint), host_number_of_three_hit_tracks_filtered),
    (HOST_OUTPUT(host_number_of_reconstructed_velo_tracks_t, uint), host_number_of_reconstructed_velo_tracks),
