...
namespace Hlt1 {
  ...
  template<typename U, typename F>
  struct TraverseLinesScaleFactorsImpl<std::tuple<>, U, F, std::index_sequence<>, void> {
    constexpr static void traverse(const F&) {}
  };
  ...
  struct TraverseLinesScaleFactorsImpl<
    ...
    constexpr static void traverse(const F& lambda_fn)
    {
      ...
      TraverseLinesScaleFactorsImpl<std::tuple<OtherLines...>, U, F, std::index_sequence<Is...>>::traverse(lambda_fn);
    }
  };
  ...
  struct TraverseLinesScaleFactors {
    constexpr static void traverse(const F& lambda_fn)
    {
      TraverseLinesScaleFactorsImpl<T, U, F, std::make_index_sequence<std::tuple_size<T>::value>>::traverse(lambda_fn);
    }
  };
} // namespace Hlt1
