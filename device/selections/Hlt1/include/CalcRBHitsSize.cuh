...
namespace calc_rb_hits_size {
  struct Parameters {
    ...
    // DEVICE_INPUT(dev_multi_event_particle_containers_t, Allen::Views::Physics::IMultiEventParticleContainer*) dev_multi_event_particle_containers;
    ...
    DEVICE_OUTPUT_WITH_DEPENDENCIES(
      ...
      DEPENDENCIES(dev_sel_track_count_t, dev_sel_track_indices_t, dev_sel_track_inserts_t),
    ...
    DEVICE_OUTPUT_WITH_DEPENDENCIES(
      dev_sel_sv_tables_t,
      DEPENDENCIES(dev_sel_sv_count_t, dev_sel_sv_indices_t, dev_sel_sv_inserts_t),
      Selections::CandidateTable)
    dev_sel_sv_tables;
