...
namespace Muon {
  ...
  public:
    ...
    __device__ inline unsigned int RegionOfLink(unsigned int tell40_num, unsigned int PCI_num, unsigned int link_num) const
    {
      assert(tell40_num <= maxTell40Number);
      assert(PCI_num <= maxTell40PCINumber);
    ...
    __device__ inline unsigned int QuarterOfLink(unsigned int tell40_num, unsigned int PCI_num, unsigned int link_num) const
    {
      assert(tell40_num <= maxTell40Number);
      assert(PCI_num <= maxTell40PCINumber);
      assert(link_num <= maxNumberLinks);      
    ...
    __device__ inline unsigned int TileInTell40(unsigned int tell40_num, unsigned int PCI_num, unsigned int link_num, unsigned int ch_num) const
    {
      assert(tell40_num <= maxTell40Number);
      assert(PCI_num <= maxTell40PCINumber);
      assert(link_num <= maxNumberLinks);      
    ...
    __device__ unsigned int get_number_of_readout_fibers( gsl::span<const uint8_t> span_banks, 
