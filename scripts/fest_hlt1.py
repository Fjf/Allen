...
for input_files, i in chunks(mdf_files, 150):
    ...
    cmd = ['Allen', '-g', '/daqarea1/fest/allen/fest_geometry',
           '--mdf', ','.join(input_files), '--events-per-slice', '1000',
           '-m', '1000', '-t', '4',
           '--configuration', '/daqarea1/fest/allen/configuration/config.json',
           '--output-file', f'/daqarea1/fest/mdf_hlt1/{output_basename}.mdf',
           '--monitoring-filename', f'/daqarea1/fest/mdf_hlt1/histos/{output_basename}.root']
