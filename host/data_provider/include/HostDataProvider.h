...
namespace host_data_provider {
  struct Parameters {
    HOST_OUTPUT(host_raw_banks_t, Allen::device::span<char const>) host_raw_banks;
    HOST_OUTPUT(host_raw_offsets_t, Allen::device::span<unsigned int const>) host_raw_offsets;
